...
"pt.plot.plot_vdf(figsize=[5,4],vlsvobj=f, run=verifydir+REPLACEINDEX, normal=[0,0,5],normalx=[0,5,0], coordre=REPLACECOORDRE)",
...
"pt.plot.plot_vdf(figsize=[5,4],vlsvobj=f, run=verifydir+REPLACEINDEX, normal=[0,1,0],normalx=[0,0,1], coordre=REPLACECOORDRE)",
...
"pt.plot.plot_vdf(figsize=[5,4],vlsvobj=f, run=verifydir+REPLACEINDEX, normal=[-1,0,0],normalx=[0,1,0], coordre=REPLACECOORDRE)",
