"""
An example of using find_magnetopause_sw_streamline_3d() and plotting the output.
"""
...
def main():
    ...
    file_name="/wrk-vakka/group/spacephysics/vlasiator/3D/EGI/bulk/bulk5.0000070.vlsv" 
