...
def rankine(Tu, rhou, V, B, n, Vsh):
    ...
    logging.info("|BuHT|: " +str(np.linalg.norm(BuHT)))

    Emotional = -np.cross(VuHT,BuHT)
    logging.info("Verify: Motional E-field in HT frame: " + str(Emotional))
    ...
    logging.info("|Bd|: " +str(np.linalg.norm(Bd)))
    ...
    logging.info(" V " + str(VuHT/1e3))
    logging.info(" B " + str(BuHT*1e9))
    ...
    logging.info(" V " + str(VdHT/1e3))
    logging.info(" B " + str(BdHT*1e9))
