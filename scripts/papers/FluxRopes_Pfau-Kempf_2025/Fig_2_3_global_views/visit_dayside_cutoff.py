...
# Define expressions
DefineScalarExpression('curvature_radius_re', 'curvature_radius / 6371000.0')
...
for cutoff in [3.0, 5.0, 7.0]:
   filename = "FHA_dayside_fluxropes_cutoff_"+str(tindex)+"_"+str(cutoff)+".png"
...
#   SetOperatorOptions(opatts)
   ...
   AnnotationAtts.axes3D.yAxis.tickMarks.majorMinimum = -20
   AnnotationAtts.axes3D.yAxis.tickMarks.majorMaximum = 20
   ...
   AnnotationAtts.axes3D.zAxis.title.font.scale = 0.5
   ...
   AnnotationAtts.axes3D.zAxis.tickMarks.majorMinimum = -20
   AnnotationAtts.axes3D.zAxis.tickMarks.majorMaximum = 20
   AnnotationAtts.axes3D.zAxis.tickMarks.minorSpacing = 2
   AnnotationAtts.axes3D.zAxis.tickMarks.majorSpacing = 10
   AnnotationAtts.axes3D.zAxis.grid = 0
   AnnotationAtts.axes3D.setBBoxLocation = 1
   AnnotationAtts.axes3D.bboxLocation = (0, 15, -21, 21, -11, 11)
