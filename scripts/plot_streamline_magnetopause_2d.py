"""
An example of using find_magnetopause_sw_streamline_2d() and plotting the output over colormap.
"""
...
def main():
    ...
    run = 'BFD' # for output file name
    file_name="/wrk-vakka/group/spacephysics/vlasiator/2D/BFD/bulk/bulk.0002000.vlsv"
