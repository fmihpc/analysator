...
latexdict = {
    ...
    'Rhoq': r'$\rho_q$',
    'rho': r'$n_\mathrm{p}$',
    'RhoBackstream': r'$n_\mathrm{st,p}$',
    'RhoNonBackstream': r'$n_\mathrm{th,p}$',
    'rho_v': r'$\Gamma_\mathrm{p}$',
    'RhoVBackstream': r'$\Gamma_\mathrm{st,p}$',
    'RhoVNonBackstream': r'$\Gamma_\mathrm{th,p}$',
    'V': r'$V$',
    'VBackstream': r'$V_\mathrm{st,p}$',
    'VNonBackstream': r'$V_\mathrm{th,p}$',
    'B': r'$B$',
...
latexdictmultipop = {
    ...
    'RhoBackstream': r'$n_{\mathrm{st},\mathrm{REPLACEPOP}}$',
    'RhoNonBackstream': r'$n_{\mathrm{th},\mathrm{REPLACEPOP}}$',
    'rho_v': r'$\Gamma_\mathrm{REPLACEPOP}$',
    'RhoVBackstream': r'$\Gamma_{\mathrm{st,\mathrm{REPLACEPOP}}$',
    'RhoVNonBackstream': r'$\Gamma_{\mathrm{th},\mathrm{REPLACEPOP}}$',
    'V': r'$V_\mathrm{REPLACEPOP}$',
    'VBackstream': r'$V_{\mathrm{st},\mathrm{REPLACEPOP}}$',
    'VNonBackstream': r'$V_{\mathrm{th},\mathrm{REPLACEPOP}}$',
    'pressure': r'$P_\mathrm{REPLACEPOP}$',
    'pressure_dt2': r'$P_{\mathrm{d}t/2},\mathrm{REPLACEPOP}}$',
    'pressure_r': r'$P_{r,\mathrm{REPLACEPOP}}$',
    'pressure_v': r'$P_{v,\mathrm{REPLACEPOP}}$',
    'PTensorDiagonal': r'$\mathcal{P}_{\mathrm{diag},\mathrm{REPLACEPOP}}$',
    'PTensorOffDiagonal': r'$\mathcal{P}_{\mathrm{off-diag},\mathrm{REPLACEPOP}}$',
    'PTensorBackstreamDiagonal': r'$\mathcal{P}_{\mathrm{st,diag},\mathrm{REPLACEPOP}}$',
    'PTensorBackstreamOffDiagonal': r'$\mathcal{P}_{\mathrm{st,off-diag},\mathrm{REPLACEPOP}}$',
    'PTensorNonBackstreamDiagonal': r'$\mathcal{P}_{\mathrm{th,diag},\mathrm{REPLACEPOP}}$',
    'PTensorNonBackstreamOffDiagonal': r'$\mathcal{P}_{\mathrm{th,off-diag},\mathrm{REPLACEPOP}}$',
    'MinValue': r'$f_{\mathrm{Min},\mathrm{REPLACEPOP}}$',
    'EffectiveSparsityThreshold': r'$f_{\mathrm{Min},\mathrm{REPLACEPOP}}$',
    }
...
latexunitsdict = {
    ...
    'E': r'$V\,m^{-1}$',
    'E_vol': r'$V\,m^{-1}$',
    'EXHALL_000_100': r'$V\,m^{-1}$',
    'EXHALL_001_101': r'$V\,m^{-1}$',
    'EXHALL_010_110': r'$V\,m^{-1}$',
    'EXHALL_011_111': r'$V\,m^{-1}$',
    'EYHALL_000_010': r'$V\,m^{-1}$',
    'EYHALL_001_011': r'$V\,m^{-1}$',
    'EYHALL_100_110': r'$V\,m^{-1}$',
    'EYHALL_101_111': r'$V\,m^{-1}$',
    'EZHALL_000_001': r'$V\,m^{-1}$',
    'EZHALL_010_011': r'$V\,m^{-1}$',
    'EZHALL_100_101': r'$V\,m^{-1}$',
    'EZHALL_110_111': r'$V\,m^{-1}$',
    'pressure': r'Pa',
    'pressure_dt2': r'Pa',
    'pressure_r': r'Pa',
    'pressure_v': r'Pa',
